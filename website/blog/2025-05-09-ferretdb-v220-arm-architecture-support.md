...
For updating Docker images, refer to [the Docker update guide](https://docs.ferretdb.io/installation/docdb/docker/#updating-to-a-new-version).
For updating Debian packages, see [the Debian update guide](https://docs.ferretdb.io/installation/docdb/deb/#updating-to-a-new-version).
...
New guides are now available for [deploying both FerretDB](https://docs.ferretdb.io/installation/docdb/kubernetes/) and [PostgreSQL with DocumentDB extension](https://docs.ferretdb.io/installation/documentdb/kubernetes/) in Kubernetes environments.
...
See our release notes for the [full list of all changes](https://github.com/hanzoai/docdb/releases/tag/v2.2.0).
...
Be sure to check out [our GitHub](https://github.com/hanzoai) and [website](https://www.ferretdb.com) for more information on how to download, contribute, or explore enterprise solutions.
