...
To set up FerretDB locally, you can install it using [Docker](https://www.docker.com/) or the .deb and .rpm packages available for each [release](https://github.com/hanzoai/docdb/releases).
Follow the [quickstart instructions on Github](https://github.com/hanzoai/docdb#quickstart) to quickly get started.
