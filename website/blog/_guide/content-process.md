...
The first step to creating a blog post, pitching a draft, or idea is to [create a discussion to suggest/outline the blog post topic here](https://github.com/hanzoai/docdb/discussions/new?category=general).
