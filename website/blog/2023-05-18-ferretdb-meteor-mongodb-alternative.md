...
At this stage, it's unclear whether the hassles of implementing `OpLog` will be worth it, [especially with a few Meteor.js apps, like Rocket.Chat, moving to `ChangeStreams`](https://github.com/hanzoai/docdb/issues/1993#issuecomment-1518978149).
