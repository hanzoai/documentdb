...
If you missed our previous releases, see the [complete list of all the updates](https://github.com/hanzoai/docdb/releases/) to FerretDB.
...
See our [release notes](https://github.com/hanzoai/docdb/releases/tag/v0.9.2) to find out more.
...
To learn more about all the changes in the new release, please see [our release notes](https://github.com/hanzoai/docdb/releases/tag/v0.9.2).
