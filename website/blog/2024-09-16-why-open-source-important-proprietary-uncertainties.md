...
In light of the recent deprecation announcement, **[we have started working on an alternative for Data API](https://github.com/hanzoai/docdb/discussions/4578)**.
