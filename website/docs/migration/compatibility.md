...
<!--
   Each numbered point above should have a corresponding, numbered test file https://github.com/hanzoai/docdb/tree/main/integration/diff_*_test.go
...
| Command                   | Status                                                                     |
| ------------------------- | -------------------------------------------------------------------------- |
| `cloneCollectionAsCapped` | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/3631) |
| `collMod`                 | ✅️ Supported                                                              |
| `compact`                 | ✅️ Supported                                                              |
| `convertToCapped`         | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/3631) |
| `create`                  | ✅️ Supported                                                              |
| `createIndexes`           | ✅️ Supported                                                              |
| `currentOp`               | ✅️ Supported                                                              |
| `drop`                    | ✅️ Supported                                                              |
| `dropConnections`         | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1511) |
| `dropDatabase`            | ✅️ Supported                                                              |
| `dropIndexes`             | ✅️ Supported                                                              |
| `getParameter`            | ✅️ Supported                                                              |
| `killCursors`             | ✅️ Supported                                                              |
| `killOp`                  | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1515) |
| `listCollections`         | ✅️ Supported                                                              |
| `listDatabases`           | ✅️ Supported                                                              |
| `listIndexes`             | ✅️ Supported                                                              |
| `logRotate`               | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1959) |
| `reIndex`                 | ✅️ Supported                                                              |
| `renameCollection`        | ✅️ Supported                                                              |
| `setParameter`            | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1518) |
| `shutdown`                | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1519) |
...
| Command        | Status                                                                     |
| -------------- | -------------------------------------------------------------------------- |
| `authenticate` | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1731) |
| `logout`       | ✅️ Supported                                                              |
...
| `connPoolStats`         | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/4909) |
...
| `logApplicationMessage` | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/4969) |
| `ping`                  | ✅️ Supported                                                              |
| `profile`               | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/2398) |
...
| Command         | Status                                                                     |
| --------------- | -------------------------------------------------------------------------- |
| `bulkWrite`     | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/4910) |
| `delete`        | ✅️ Supported                                                              |
| `find`          | ✅️ Supported                                                              |
...
| Command                    | Status                                                                     |
| -------------------------- | -------------------------------------------------------------------------- |
| `createRole`               | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1528) |
| `dropAllRolesFromDatabase` | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1530) |
| `dropRole`                 | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1529) |
| `grantPrivilegesToRole`    | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1531) |
| `grantRolesToRole`         | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1532) |
| `revokePrivilegesFromRole` | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1534) |
| `revokeRolesFromRole`      | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1535) |
| `rolesInfo`                | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1536) |
| `updateRole`               | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1537) |

### Session commands

| Command                    | Status                                                                           |
| -------------------------- | -------------------------------------------------------------------------------- |
| `abortTransaction`         | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1547)       |
| `commitTransaction`        | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1548)       |
| `endSessions`              | ✅️ Supported                                                                    |
| `killAllSessions`          | ✅️ Supported                                                                    |
| `killAllSessionsByPattern` | [⚠️ Not fully implemented yet](https://github.com/hanzoai/docdb/issues/1551) |
...
| `grantRolesToUser`         | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1494) |
| `revokeRolesFromUser`      | [❌ Not implemented yet](https://github.com/hanzoai/docdb/issues/1495) |
