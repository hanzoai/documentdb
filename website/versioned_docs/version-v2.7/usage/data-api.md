...
It follows the [Data API OpenAPI 3.0 specification defined here](https://github.com/hanzoai/docdb/blob/refs/tags/v2.7.0/internal/dataapi/api/openapi.json).
...
```text
https://raw.githubusercontent.com/hanzoai/documentdb/refs/tags/v2.7.0/internal/dataapi/api/openapi.json
```
