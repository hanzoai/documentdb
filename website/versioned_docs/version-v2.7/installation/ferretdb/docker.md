...
[`ghcr.io/hanzoai/docdb:2.7.0`](https://ghcr.io/hanzoai/docdb:2.7.0)
...
1. Store the following in the `docker-compose.yml` file:
   ...
   services:
     postgres:
       image: ghcr.io/docdb/postgres-documentdb:17-0.107.0-ferretdb-2.7.0
       restart: on-failure
       environment:
     ...
     ferretdb:
       image: ghcr.io/hanzoai/docdb:2.7.0
       restart: on-failure
       ports:
         - 27017:27017
       environment:
