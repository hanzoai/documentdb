...
FROM --platform=$BUILDPLATFORM golang:1.26.0-bookworm AS development-prepare
...
# TODO https://github.com/FerretDB/FerretDB/issues/5449
FROM golang:1.26.0-bookworm AS development-build
...
# TODO https://github.com/FerretDB/FerretDB/issues/5449
FROM golang:1.26.0-bookworm AS development
